...
final class IDGenerator {
     ...
     * @param pstFile The PSTFile this message belongs to.
     * @return The ID of the message.
     */
    static String getID(PSTObject message, PSTFile pstFile) {
        return message.getDescriptorNodeId() + "-" + getID(pstFile);
    }
